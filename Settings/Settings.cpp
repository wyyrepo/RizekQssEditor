...
void settings::loadSettings()
{
    ...
    label_12->setText(set.value(QStringLiteral("TextEdit/HTC"),QColor("#ffffff")).toString());
	//---Подсветка--текст
    label_14->setText(set.value("Highlighter\\ColorOfLocationFormat", QColor("#808000")).toString());
    label_16->setText(set.value("Highlighter\\ColorOfObjectFormat", QColor("#0000ff")).toString());
    label_18->setText(set.value("Highlighter\\ColorOfFunctionFormat", QColor("#800000")).toString());
    label_20->setText(set.value("Highlighter\\ColorOfClassesFormat", QColor("#008080")).toString());
    label_22->setText(set.value("Highlighter\\ColorOfValuesFormat", QColor("#0000ff")).toString());
    label_24->setText(set.value("Highlighter\\ColorOfPseudoStatesFormat", QColor("#800080")).toString());
    label_26->setText(set.value("Highlighter\\ColorOfSubControlsFormat", QColor("#800000")).toString());
    label_28->setText(set.value("Highlighter\\ColorOfColorsFormat", QColor::fromRgb(85, 170, 255)).toString());
    label_30->setText(set.value("Highlighter\\ColorOfCommentFormat", QColor("#ff0000")).toString());
	//---Подсветка--цвета
    colorOfLocation.setNamedColor(set.value("Highlighter\\ColorOfLocationFormat", QColor("#808000")).toString());
    colorOfObject.setNamedColor(set.value("Highlighter\\ColorOfObjectFormat", QColor("#0000ff")).toString());
    colorOfFunction.setNamedColor(set.value("Highlighter\\ColorOfFunctionFormat", QColor("#800000")).toString());
    colorOfClasses.setNamedColor(set.value("Highlighter\\ColorOfClassesFormat", QColor("#008080")).toString());
    colorOfValues.setNamedColor(set.value("Highlighter\\ColorOfValuesFormat", QColor("#0000ff")).toString());
    colorOfPseudoStates.setNamedColor(set.value("Highlighter\\ColorOfPseudoStatesFormat", QColor("#800080")).toString());
    colorOfSubControls.setNamedColor(set.value("Highlighter\ColorOfSubControlsFormat", QColor("#800000")).toString());
    colorOfColors.setNamedColor(set.value("Highlighter\\ColorOfColorsFormat", QColor::fromRgb(85, 170, 255)).toString());
    colorOfComment.setNamedColor(set.value("Highlighter\\ColorOfCommentFormat", QColor("#ff0000")).toString());
	//Палитра
...
{ 
    ...
    //set.setValue("Highlighter\C\olorOfSubControlsFormat", c.name());
}
